...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <div class="card">
                <div class="card-header">{{ __('Thêm sản phẩm thuốc') }}
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row mb-3" style="padding-top: 20px">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="usage" id="usage" rows="4">{{old('usage')}}</textarea>
                                        @error('usage')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <div class="row mb-3" style="padding-top: 20px">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="image[]" accept="image/*" class="form-control" multiple required>
                                    </div>
                                </div>
                            </div>
