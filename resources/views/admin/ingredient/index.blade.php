...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header">
            <h4>Quản lý hoạt chất
                <a href="{{url('admin/ingredient/create')}}" class="btn btn-primary btn-md btn-block float-end">
                    <i class="mdi mdi-leaf"></i>
                    Thêm hoạt chất
                </a>
            </h4>
        </div>
        <form action="{{url('admin/ingredient/search')}}" method="GET">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="card-header">
                <div class="input-group">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Tìm kiếm hoạt chất" aria-label="search"
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/ingredient/edit/'.$ingredient->id)}}" class="btn btn-outline-secondary btn-icon-text">
                                Sửa
                                <i class="mdi mdi-file-check btn-icon-append"></i>
                            </a>
                            <a href="{{url('admin/ingredient/delete/'.$ingredient->id)}}" onclick="return confirm('Bạn có chắc muốn xóa hoạt chất này?')" class="btn btn-outline-danger btn-icon-text">
                                Xóa
                    ...
                    @empty
                    <tr>
                        <td colspan="3">Không có hoạt chất nào</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
