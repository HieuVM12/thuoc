        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Sửa người dùng') }}
                    <a href="{{url('/admin/user/')}}" class="btn btn-primary btn-md btn-block float-end"><i
                            class="mdi mdi-arrow-left-bold"></i>Quay lại</a>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{url('admin/user/update/'.$user->id)}}" id="validatedForm">
                        @csrf
                        @method('put')
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="unit_code" type="text"
                                    ...
                                    value="{{ $user->unit_code }}" required autocomplete="unit_code" autofocus>
