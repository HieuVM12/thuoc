...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header">
            <h4>Quản lý nhóm thuốc
                <a href="{{url('admin/category/create')}}" class="btn btn-primary btn-md btn-block float-end">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$category->name}}</td>
                        <td>
                            <a href="{{url('admin/category/edit/'.$category->id)}}" class="btn btn-outline-secondary btn-icon-text">
                                Sửa
                                <i class="mdi mdi-file-check btn-icon-append"></i>
                            </a>
                            <a href="{{url('admin/category/delete/'.$category->id)}}" onclick="return confirm('Bạn có chắc muốn xóa nhóm thuốc này?')" class="btn btn-outline-danger btn-icon-text">
                                Xóa
